...
namespace Hypermedia.JsonApi.AspNetCore.Formatters
{
    public class JsonApiOutputFormatter : JsonOutputFormatter
    {
        ...
        public JsonApiOutputFormatter(IContractResolver contractResolver) : this(new JsonApiSerializerOptions { ContractResolver = contractResolver, FieldNamingStrategy = DasherizedFieldNamingStrategy.Instance  }) { }
